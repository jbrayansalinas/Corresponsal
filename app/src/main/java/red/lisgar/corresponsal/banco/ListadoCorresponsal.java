...
import red.lisgar.corresponsal.adaptadores.ListaCorresponsalAdapter;
import red.lisgar.corresponsal.db.DbCliente;
import red.lisgar.corresponsal.db.DbCorresponsal;

public class ListadoCorresponsal extends AppCompatActivity {
    ...
    ListaCorresponsalAdapter adapter;
    ...
    private void layoutListado(){
        ...
        titulolistado.setText("Listado Corresponsales");
        buscadorlistado.setHint("NIT corresponsal");
        ...
        atras_listado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListadoCorresponsal.this, Banco.class);
    ...
    private void mostrarDatos(){
        ...
        if (dbCorresponsal.listaCorresponsal()!=null){
            recyclerlistado.setLayoutManager(new LinearLayoutManager(this));
            adapter = new ListaCorresponsalAdapter(dbCorresponsal.listaCorresponsal());
