...
public class Corresponsal {
    ...
    private String contrasena_corresponsal;
    ...
    public String getContrasena_corresponsal() {
        return contrasena_corresponsal;
    }

    public void setContrasena_corresponsal(String contrasena_corresponsal) {
        this.contrasena_corresponsal = contrasena_corresponsal;
    }
